...
import (
	...
	"litemall-srvs/inventory_srv/handler"
	"litemall-srvs/inventory_srv/utils/register/consul"
	"net"
	"os"
	"os/signal"
	"syscall"
	...
	"litemall-srvs/inventory_srv/initialize"
	"litemall-srvs/inventory_srv/proto"
	"litemall-srvs/inventory_srv/utils"
)
