...
type OrderGoods struct {
	gorm.Model
	OrderId                   uint    `gorm:"type:mediumint(8) unsigned NOT NULL DEFAULT '0';index:order_id"`
	GoodsId                   uint    `gorm:"type:mediumint(8) unsigned NOT NULL DEFAULT '0';index:goods_id"`
	...
	Number                    uint    `gorm:"type:mediumint(8) unsigned NOT NULL DEFAULT '1'"`
	MarketPrice               float64 `gorm:"type:decimal(10,2) NOT NULL DEFAULT '0.00'"`
	RetailPrice               float64 `gorm:"type:decimal(10,2) NOT NULL DEFAULT '0.00'"`
	GoodsSpecifitionNameValue string  `gorm:"type:varchar(255) NOT NULL DEFAULT ''"`
	IsReal                    uint    `gorm:"type:tinyint(1) unsigned NOT NULL DEFAULT '0'"`
